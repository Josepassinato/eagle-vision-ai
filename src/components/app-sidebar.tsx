...
import { Users, Map, Settings, LayoutDashboard, List, Gauge, Shield, CreditCard, PlayCircle, HardHat, GraduationCap, ShieldCheck, HardDrive, Activity, Sliders, CheckSquare, TestTube, Church, BarChart3 } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const items = [
  ...
  { title: "Dashboard Executivo", url: "/app/vertical-dashboard", icon: BarChart3 },
  { title: "Vision4Church", url: "/app/church", icon: Church },
