...
import { Users, Map, Settings, LayoutDashboard, List, Gauge, Shield, CreditCard, PlayCircle, HardHat, GraduationCap, ShieldCheck, HardDrive, Activity, Sliders } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
