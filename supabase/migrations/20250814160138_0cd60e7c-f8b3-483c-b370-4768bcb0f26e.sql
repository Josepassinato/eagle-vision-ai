...
CREATE TABLE IF NOT EXISTS public.webhook_configurations (
  ...
  event_types ARRAY NOT NULL, -- array of event types to trigger webhook
...
CREATE TABLE IF NOT EXISTS public.notification_channels (
  ...
  webhook_url TEXT,
  notification_types ARRAY NOT NULL, -- types of notifications to send
  is_active BOOLEAN DEFAULT true,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
...
-- Insert default webhook event types and notification types
INSERT INTO public.app_config (key, value) VALUES
  ('webhook_event_types', '["incident_created", "incident_resolved", "alert_triggered", "user_login", "system_health", "analytics_report"]'),
  ('notification_types', '["alerts", "incidents", "reports", "system_status", "user_activity"]'),
  ('supported_integrations', '["teams", "slack", "salesforce", "hubspot", "zapier", "custom"]')
